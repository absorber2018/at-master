...
class Downgrade {
    ...
    @Test
    fun test2(){
        val reader = BufferedReader(FileReader("C:\\Users\\Blanca\\Desktop\\t10-downgrade.txt"))
        var bool = true
        while(bool){
    ...
    private fun downgrade(machineCode:String){
        val server = "https://test.derucci-smart.com"
